...
export const SignupEmail = ({
  ...
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>Welcome to SaloneMakitSL – confirm your email</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Heading style={h1}>Welcome to SaloneMakitSL!</Heading>
        <Text style={text}>
...
const link = { color: 'hsl(152, 55%, 33%)', textDecoration: 'underline' }
const button = {
